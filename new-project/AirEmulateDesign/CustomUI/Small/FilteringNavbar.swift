    ...
    var body: some View {
        VStack {
            ...
            Text(iconType.sendTitleOfIcon())
                .font(FontTurboGearCycle.montserratStyle(size: bigSize ? 18 : 14, type: .medium))
        }
        .foregroundColor(iconType == choosedIconType ? Color.white : ColorRide.colorPicker(.darkGray))
    }
}
